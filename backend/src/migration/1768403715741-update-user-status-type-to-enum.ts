...
export class UpdateUserStatusTypeToEnum1768403715741 implements MigrationInterface {
    name = 'UpdateUserStatusTypeToEnum1768403715741'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "username" varchar NOT NULL, "status" varchar NOT NULL, "roles" text NOT NULL DEFAULT ('["regular"]'), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"))`);
        await queryRunner.query(`INSERT INTO "temporary_users"("id", "username", "status", "roles") SELECT "id", "username", "status", "roles" FROM "users"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`ALTER TABLE "temporary_users" RENAME TO "users"`);
    }
