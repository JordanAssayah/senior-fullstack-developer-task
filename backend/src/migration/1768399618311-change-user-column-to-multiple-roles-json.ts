...
export class ChangeUserColumnToMultipleRolesJson1768399618311 implements MigrationInterface {
    name = 'ChangeUserColumnToMultipleRolesJson1768399618311'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_users" ("id" integer PRIMARY KEY, "username" text NOT NULL, "status" integer, "roles" text NOT NULL DEFAULT ('["regular"]'), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"))`);
        await queryRunner.query(`INSERT INTO "temporary_users"("id", "username", "status") SELECT "id", "username", "status" FROM "users"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`ALTER TABLE "temporary_users" RENAME TO "users"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" integer PRIMARY KEY, "username" text NOT NULL, "status" integer, "roles" text NOT NULL DEFAULT ('["regular"]'), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"))`);
